...
5. What's the current renewable share, carbon intensity, and year-over-year change? — KPI cards
...
Work was structured as Jira-style epics and stories (Data Extraction → Transformation → Warehouse/Query Layer → Dashboard Build → Documentation), mirroring how a real data team scopes and tracks delivery.
